...
public abstract class AbstractBettaFish extends BettasWaterAnimal implements Bucketable {

    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(AbstractBettaFish.class, EntityDataSerializers.BOOLEAN);

    public AbstractBettaFish(EntityType<? extends AbstractBettaFish> p_27461_, Level p_27462_) {
        super(p_27461_, p_27462_);
        this.moveControl = new AbstractBettaFish.FishMoveControl(this);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new AbstractBettaFish.FishSwimGoal(this));
    }
    ...
    static class FishMoveControl extends MoveControl {
        private final AbstractBettaFish fish;

        FishMoveControl(AbstractBettaFish p_27501_) {
            super(p_27501_);
            this.fish = p_27501_;
        }
    ...
    static class FishSwimGoal extends RandomSwimmingGoal {
        ...
        public FishSwimGoal(AbstractBettaFish p_27505_) {
