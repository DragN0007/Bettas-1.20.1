...
public abstract class BettasWaterAnimal extends Animal {
   protected BettasWaterAnimal(EntityType<? extends BettasWaterAnimal> p_30341_, Level p_30342_) {
      super(p_30341_, p_30342_);
      this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
   }

   public static boolean checkSurfaceWaterAnimalSpawnRules(EntityType<? extends BettasWaterAnimal> p_218283_, LevelAccessor p_218284_, MobSpawnType p_218285_, BlockPos p_218286_, RandomSource p_218287_) {
