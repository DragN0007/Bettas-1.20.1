...
public class GoldfishEntity extends AbstractSchoolingFish implements GeoEntity {

    public GoldfishEntity(EntityType<? extends AbstractSchoolingFish> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
...
//Bucket
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(BettasMain.GOLDFISH_BUCKET.get());
    }



    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(GoldfishEntity.class, EntityDataSerializers.INT);
    @Override
