...
public class PlecoEntity extends AbstractFish implements GeoEntity {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.PLECO_BUCKET.get().getDefaultInstance();
    }



    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(PlecoEntity.class, EntityDataSerializers.INT);
    @Override
