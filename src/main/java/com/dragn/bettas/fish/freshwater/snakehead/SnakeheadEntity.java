...
public class SnakeheadEntity extends AbstractSchoolingFish implements GeoEntity {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);


    public SnakeheadEntity(EntityType<? extends AbstractSchoolingFish> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(BettasMain.SNAKEHEAD_BUCKET.get());
    }




    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(SnakeheadEntity.class, EntityDataSerializers.INT);
    @Override
