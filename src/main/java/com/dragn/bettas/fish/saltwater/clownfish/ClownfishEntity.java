...
public class ClownfishEntity extends AbstractSchoolingFish implements GeoEntity {


    public ClownfishEntity(EntityType<? extends AbstractSchoolingFish> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(BettasMain.CLOWNFISH_BUCKET.get());
    }
