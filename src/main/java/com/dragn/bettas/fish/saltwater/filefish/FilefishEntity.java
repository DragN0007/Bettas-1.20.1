...
public class FilefishEntity extends AbstractFish implements GeoEntity {
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(BettasMain.FILEFISH_BUCKET.get());
    }




    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(FilefishEntity.class, EntityDataSerializers.INT);
    @Override
