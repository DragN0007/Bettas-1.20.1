...
public class JellyEntity extends AbstractSchoolingFish implements GeoEntity {


    public JellyEntity(EntityType<? extends AbstractSchoolingFish> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(BettasMain.JELLY_BUCKET.get());
    }
