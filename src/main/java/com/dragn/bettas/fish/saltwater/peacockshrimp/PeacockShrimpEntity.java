...
public class PeacockShrimpEntity extends AbstractFish implements GeoEntity {

    private static final EntityDataAccessor<Integer> TEXTURE = SynchedEntityData.defineId(PeacockShrimpEntity.class, EntityDataSerializers.INT);

    public static boolean checkBettasAquaticsSpawnRules(EntityType<PeacockShrimpEntity> entity, ServerLevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public PeacockShrimpEntity(EntityType<? extends PeacockShrimpEntity> entityType, Level world) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.PEACOCKSHRIMP_BUCKET.get().getDefaultInstance();
    }
