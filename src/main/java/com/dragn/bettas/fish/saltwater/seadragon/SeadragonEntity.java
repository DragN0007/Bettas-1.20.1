...
public class SeadragonEntity extends AbstractSchoolingFish implements GeoEntity {

    public SeadragonEntity(EntityType<? extends SeadragonEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }

    public static boolean checkBettasAquaticsSpawnRules(EntityType<SeadragonEntity> entity, LevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.SEADRAGON_BUCKET.get().getDefaultInstance();
    }



    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(SeadragonEntity.class, EntityDataSerializers.INT);
    @Override
